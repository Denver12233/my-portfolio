      ...
      <div className="px-6 py-20 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:tandingandenverm@gmail.com" className="text-sm text-neutral-500 dark:text-neutral-400 hover:text-accent-600 transition-colors">
                tandingandenverm@gmail.com
              </a>
              <a href="https://github.com/Denver12233" target="_blank" rel="noopener noreferrer" className="text-sm text-neutral-500 dark:text-neutral-400 hover:text-accent-600 transition-colors">
                github.com/Denver12233
              </a>
              <a href="https://www.linkedin.com/in/tandingan-denver-m-374910392/" target="_blank" rel="noopener noreferrer" className="text-sm text-neutral-500 dark:text-neutral-400 hover:text-accent-600 transition-colors">
                LinkedIn
              </a>
            </div>
          </div>
